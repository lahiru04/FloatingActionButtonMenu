package com.religious.floatingx;
...
public class FloatingActionMenu extends ViewGroup {
    ...
    private FloatingActionButtonx mMenuButton;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mMenuFabSize = attr.getInt(R.styleable.FloatingActionMenu_menu_fab_size, FloatingActionButtonx.SIZE_NORMAL);
    ...
    private void createMenuButton() {
        mMenuButton = new FloatingActionButtonx(getContext());
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = mButtonsCount - 1; i >= 0; i--) {
            ...
            FloatingActionButtonx fab = (FloatingActionButtonx) child;
    ...
    private void createLabels() {
        for (int i = 0; i < mButtonsCount; i++) {
            ...
            final FloatingActionButtonx fab = (FloatingActionButtonx) getChildAt(i);
    ...
    private void addLabel(FloatingActionButtonx fab) {
    ...
    public void open(final boolean animate) {
        if (!isOpened()) {
            ...
            for (int i = getChildCount() - 1; i >= 0; i--) {
                View child = getChildAt(i);
                if (child instanceof FloatingActionButtonx && child.getVisibility() != GONE) {
                    counter++;

                    final FloatingActionButtonx fab = (FloatingActionButtonx) child;
    ...
    /**
     * Makes the {@link FloatingActionButtonx} to appear inside the {@link #FloatingActionMenu} and
    ...
    /**
     * Makes the {@link FloatingActionButtonx} to disappear inside the {@link #FloatingActionMenu} and
    ...
    public void addMenuButton(FloatingActionButtonx fab) {
        addView(fab, mButtonsCount - 2);
        mButtonsCount++;
        addLabel(fab);
    }

    public void removeMenuButton(FloatingActionButtonx fab) {
        removeView(fab.getLabelView());
        removeView(fab);
        mButtonsCount--;
    }

    public void addMenuButton(FloatingActionButtonx fab, int index) {
    ...
    public void removeAllMenuButtons() {
        ...
        List<FloatingActionButtonx> viewsToRemove = new ArrayList<>();
        for (int i = 0; i < getChildCount(); i++) {
            View v = getChildAt(i);
            if (v != mMenuButton && v != mImageToggle && v instanceof FloatingActionButtonx) {
                viewsToRemove.add((FloatingActionButtonx) v);
            }
        }
        for (FloatingActionButtonx v : viewsToRemove) {
            removeMenuButton(v);
        }
    }
